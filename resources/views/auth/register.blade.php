...
<head>
    ...
    <title>SB Admin 2 - Tables - Đăng ký</title>
    <base href="{{asset('')}}">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            @endif
                            <form class="user" action="{{ route('registerStore') }}" method="POST">
                                @csrf
                                ...
                                <div class="form-group">
                                    <input type="text" name="name" value="{{ old('name') }}" class="form-control form-control-user" id="exampleInputname"
                            ...
                            <div class="text-center">
                                <a class="small" href="{{ route('auth.getLoginForm') }}">Already have an account? Login!</a>
                            </div>
                        </div>
                    </div>
                </div>
